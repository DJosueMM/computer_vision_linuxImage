# -*- coding: utf-8 -*-
"""401-object-detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/openvinotoolkit/openvino_notebooks/blob/main/notebooks/401-object-detection-webcam/401-object-detection.ipynb
"""
    ...
    try:
        ...
        while True:
            ...
            if use_popup:
                ...
                # Show the image using OpenCV's imshow function.
                cv2.imshow("Object Detection", cv2.imdecode(np.frombuffer(image_bytes, np.uint8), cv2.IMREAD_COLOR))
                # Wait for a key press. You can adjust the delay time if needed.
                cv2.waitKey(1)
    # ctrl-c
