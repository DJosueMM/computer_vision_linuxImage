...
def process_image(image):
    try:
        ...
        # Devuelve None para indicar que el frame no pudo ser procesado
        return None
...
while True:
    ...
    if not ret:
        print("El video termino.")
        break

    # Almacenar el frame original
